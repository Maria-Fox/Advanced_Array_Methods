...
function vowelCount(str) {
  ...
  splitStr.forEach(function (letter) {
    let allCasedLetters = letter.toLowerCase();
    if (vowels.indexOf(allCasedLetters) !== -1) {
      if (returnObj[allCasedLetters]) {
        returnObj[allCasedLetters]++;
      } else {
        returnObj[allCasedLetters] = 1;
      }
    }
  });
  return returnObj;
...
function removeVowels(str) {
  let vowels = "aeiou";
  let casedString = str.toLowerCase();
